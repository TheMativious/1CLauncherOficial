...
class Login {
    ...
    async loginMojang() {
        ...
        loginBtn.addEventListener("click", async () => {
            ...
            if (mailInput.value == "") {
                infoLogin.innerHTML = "Ingresa un nick";
            ...
            if (account_connect == null || account_connect.error) {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'Nick invalido.'
                return
            }
    ...
    async loginOffline() {
        ...
        loginBtn.addEventListener("click", async () => {
            ...
            if (mailInput.value == "") {
                infoLogin.innerHTML = "Necesitas un nickname para loguearte!"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            if (mailInput.value.length < 3) {
                infoLogin.innerHTML = "Nick muy corto o con caracteres especiales!"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
